...
int main() {
    ...
    std::cout << "=================================" << std::endl;
    std::cout << "JUCE GUI not available in this build." << std::endl;
    std::cout << "" << std::endl;
    ...
    std::cout << "✓ Multi-resolution heatmap support" << std::endl;
    std::cout << "" << std::endl;
    ...
    std::cout << "3. Rebuild with: build.bat --release" << std::endl;
    std::cout << "" << std::endl;
    
    // Initialize core components to test integration
    try {
        yvc::MetricsBus metricsBus;
        std::cout << "✓ Core MetricsBus initialized successfully" << std::endl;
        
        // Simulate some metrics processing
        ...
        std::cout << std::endl;
        std::cout << "✓ Core integration test completed successfully" << std::endl;
    ...
    std::cout << "" << std::endl;
    std::cout << "VoiVoi Analyzer core is ready!" << std::endl;
