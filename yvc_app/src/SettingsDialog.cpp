...
namespace yvc::app {
    ...
    /// </summary>
    void SettingsDialog::showDialog(const AppSettings& currentSettings,
    ...
    /// </summary>
    SettingsDialog::SettingsDialog(const AppSettings& currentSettings,
                                   juce::AudioDeviceManager& audioDeviceManager,
                                   OnClose onClose)
    ...
    /// </summary>
    void SettingsDialog::layoutTabItems(juce::Component* tab,
                                        const std::vector<std::pair<juce::Component*,
