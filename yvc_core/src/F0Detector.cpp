...
namespace yvc {
    ...
    void F0Detector::setF0Range(float min_f0,
                                float max_f0) {
        min_f0_ = min_f0;
        max_f0_ = max_f0;
    ...
    void F0Detector::setHysteresis(float voiced_threshold,
                                   float unvoiced_threshold) {
    ...
    float F0Detector::detect(const Sample* samples,
                             size_t num_samples,
                             bool& valid) {
    ...
    float F0Detector::computeYIN(const Sample* samples,
                                 size_t num_samples,
                                 float& confidence) {
    ...
    float F0Detector::computeAutocorrelation(const Sample* samples,
                                             size_t num_samples) {
