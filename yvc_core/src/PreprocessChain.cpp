...
namespace yvc {
    ...
    /// </summary>
    void PreprocessChain::addProcessor(const ProcessorPtr& processor,
    ...
    /// </summary>
    void PreprocessChain::process(const float* in,
                                  float* out,
                                  size_t n,
                                  PreprocessTarget target) const {
        if(!in || !out || n == 0) {
            return;
        }
    ...
    /// </summary>
    void PreprocessChain::setParams(const std::string& name,
